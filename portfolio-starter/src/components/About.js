        ...
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen ">
          ...
          >
            ...
            <p className="mb-5">
              ...
              aliquam illum optio id rerum, similique corrupti reprehenderit
              esse suscipit molestiae aliquid recusandae excepturi laboriosam
              atque tenetur dolor maiores reiciendis libero.
            </p>
